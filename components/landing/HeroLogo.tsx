...
export function HeroLogo() {
  return (
    <div className="absolute top-[42px] burger-range:top-[120px] desktop:top-[206px] left-1/2 -translate-x-1/2 z-30 pointer-events-none">
      <div className="relative">
        ...
        >
          <svg 
            className="h-8 sm:h-10 md:h-12 burger-range:h-[12vw] lg:h-16 desktop:h-[102px] w-auto mx-auto [&_.apex-part]:fill-white [&_.e3-part]:fill-accent"
