...
${'═'.repeat(50)}
Generated by A.L.I.C.E. Research Platform
...
${'═'.repeat(50)}
A.L.I.C.E. Research Platform | Due Diligence Module v2.4
${'═'.repeat(50)}`
}
      ...
      <div className="container-main relative z-10">
        ...
        >
          ...
          <p className="text-lg text-content-secondary max-w-2xl mx-auto">
            One glance. Complete conviction. See how A.L.I.C.E. transforms raw data into 
            ...
            <div className="flex items-center justify-between px-4 py-3 bg-surface-700 border-b border-border">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-mono text-content-tertiary">
                  A.L.I.C.E. Research Terminal v2.4.1
                </span>
              </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-content-tertiary">
                      {selectedTicker} • Generated by A.L.I.C.E.
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
