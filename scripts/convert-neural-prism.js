...
const objPath = path.join(__dirname, '../apexe3-website/models/deep_neural_network_prism.obj');
const outputPath = path.join(__dirname, '../components/animations/neuralPrismWireframeData.ts');
...
const tsContent = `// Neural Prism Wireframe: ${vertices.length} vertices, ${normalizedEdges.length} edges
export const NEURAL_PRISM_WIREFRAME_DATA: [number, number, number][][] = ${JSON.stringify(normalizedEdges, null, 2)};
`;
